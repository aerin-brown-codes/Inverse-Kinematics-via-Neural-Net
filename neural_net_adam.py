...
if __name__ == "__main__":
    # Syntax = python neural_net_adam.py <hidden layers> <width> <activation_func_number> <loss_func_number> <training rounds> <load?> <save?> 
    ...
    pickle_file = f"nna_h{hidden_layers}_w{width}_a{activation_func_number}_l{loss_func_number}"
    log_file = f"nna_log_h{hidden_layers}_w{width}_a{activation_func_number}_l{loss_func_number}.txt"
